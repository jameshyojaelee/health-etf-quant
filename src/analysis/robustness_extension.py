...
def sweep_rotation_parameters(
    ...
    results = []
    for lb, k, use_ts, tv, mg in itertools.product(lookbacks, top_ks, use_ts_flags, target_vols, max_gross_list):
...
def sweep_regime_ls_parameters(
    ...
    results = []
    for sm_th, tg in itertools.product(spread_mom_thresholds, target_gross_list):
